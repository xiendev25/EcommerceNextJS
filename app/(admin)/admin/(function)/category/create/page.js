    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const categoriesList = Array.isArray(json) ? json : [];
                setAllCategories(categoriesList);

                const initialSiblings = categoriesList.filter(c => Number(c.parent_id) === Number(form.parent_id));
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-8">
                    ...
                    <div className="bg-white p-6 shadow-sm rounded-lg border">
                        ...
                        {imagePreview && (
                            <div className="mt-4">
                                <Image src={imagePreview} alt="Preview" width={120} height={120} className="rounded border border-gray-300 object-cover" unoptimized />
                            </div>
                        )}
                    </div>
                </div>
