...
export default function Page() {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            if (!resData.ok) throw new Error(`Không thể lấy thông tin danh mục (HTTP ${resData.status})`);
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {[...Array(10)].map((_, i) => (
                                    <tr key={i}>
                                        ...
                                        <td className="px-6 py-4"><div className="w-20 h-20 bg-gray-200 rounded" /></td>
                                    ...
                                    <tr className="hover:bg-gray-50" key={category.id}>
                                        ...
                                        <td className="px-6 py-4">
                                            {category.parent_id === 0 ? (
                                                ...
                                                <span className='text-gray-500'>{category.parent?.name || 'Không xác định'}</span>
                                            )}
                                        </td>
                                        <td className="px-6 py-4">
